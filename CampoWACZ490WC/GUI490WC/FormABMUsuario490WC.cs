    ...
    public partial class FormABMUsuario490WC : Form, iObserverLenguaje490WC
    {
        ...
        private void BT_ALTA_USUARIO490WC_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (UserManager490WC.UserManagerSG490WC.VerificarDNI490WC(dni490WC) == true)
                {
                    if (UserManager490WC.UserManagerSG490WC.VerificarDNIDuplicado490WC(dni490WC) == false)
                    {
                        if (UserManager490WC.UserManagerSG490WC.VerificarEmail490WC(email490WC) == true)
                        {
                            if (UserManager490WC.UserManagerSG490WC.VerificarEmailDuplicado490WC(email490WC) == false)
                            {
                                if (UserManager490WC.UserManagerSG490WC.VerificarUsernameDuplicado490WC(username490WC) == false)
                                {
                                    if (!string.IsNullOrEmpty(nombre490WC))
                                    {
                                        ...
                                        {
                                            string mensajeError490WC = Traductor490WC.TraductorSG490WC.Traducir490WC("ErrorIngresarApellido");
                                    ...
                                    {
                                        string mensajeError490WC = Traductor490WC.TraductorSG490WC.Traducir490WC("ErrorIngresarNombre");
                                        MessageBox.Show(mensajeError490WC);
                                        VaciarTextBox490WC(this);
                                    }
                                }
                                ...
                                {
                                    string mensajeError490WC = Traductor490WC.TraductorSG490WC.Traducir490WC("ErrorUsuarioDuplicado");
                                    MessageBox.Show(mensajeError490WC);
                                    VaciarTextBox490WC(this);
                                }
                            }
                            ...
                            {
                                string mensajeError490WC = Traductor490WC.TraductorSG490WC.Traducir490WC("ErrorEmailDuplicado");
                                MessageBox.Show(mensajeError490WC);
                                VaciarTextBox490WC(this);
                            }
                        }
                        ...
                        {
                            string mensajeError490WC = Traductor490WC.TraductorSG490WC.Traducir490WC("ErrorEmailFormatoIncorrecto");
                            MessageBox.Show(mensajeError490WC);
                            VaciarTextBox490WC(this);
                        }
                    }
                    ...
                    {
                        string mensajeError490WC = Traductor490WC.TraductorSG490WC.Traducir490WC("ErrorDNIDuplicado");
                        MessageBox.Show(mensajeError490WC);
                        VaciarTextBox490WC(this);
                    }
                ...
                {
                    string mensajeError490WC = Traductor490WC.TraductorSG490WC.Traducir490WC("ErrorDNIFormatoIncorrecto");
                    MessageBox.Show(mensajeError490WC);
                    VaciarTextBox490WC(this);
                }
            }
            ...
            {
                string mensajeError490WC = Traductor490WC.TraductorSG490WC.Traducir490WC("ErrorSeleccionarRol");
                MessageBox.Show(mensajeError490WC);
                VaciarTextBox490WC(this);
            }
        }
        ...
        private void BT_BAJA_USUARIO490WC_Click(object sender, EventArgs e)
        {
            ...
            {
                string mensajeError490WC = Traductor490WC.TraductorSG490WC.Traducir490WC("ErrorSeleccionarUsuarioBaja");
                MessageBox.Show(mensajeError490WC);
            }
        ...
        private void BT_MODIFICAR_USUARIO490WC_Click(object sender, EventArgs e)
        {
            ...
            {
                string mensajeError490WC = Traductor490WC.TraductorSG490WC.Traducir490WC("ErrorSeleccionarUsuarioModificar");
                MessageBox.Show(mensajeError490WC); 
            }
        ...
        private void BT_DESBLOQUEAR_USUARIO490WC_Click(object sender, EventArgs e)
        {
            ...
            {
                string mensajeError490WC = Traductor490WC.TraductorSG490WC.Traducir490WC("ErrorSeleccionarUsuarioDesbloquear");
                MessageBox.Show(mensajeError490WC); 
            }
        }
        ...
        {
            string url490WC = "https://docs.google.com/document/d/1t_JRHT2qTTKtLFoMya_crxzjGGV8YCpOtCnVOV4gSw0/edit?tab=t.0#heading=h.w4zsyaawvlo2";
